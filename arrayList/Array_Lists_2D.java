...
public class Array_Lists_2D {
    ...
    // Imp. Qus. # pair sum2 (here ArrayList sorted but in rotation mainer)
    public static boolean pairSum2(ArrayList<Integer> list, int target) {

        int bp = -1;
        int n = list.size();
        for (int i = 0; i < list.size(); i++) {// breking point
    ...
    // Imp. Qus. # pair Sum2 implimantetion
    public static void pairSum2Imp() {
        ArrayList<Integer> list = new ArrayList<>();
        // 11 15 6 8 9 10
        list.add(11);
        list.add(15);
